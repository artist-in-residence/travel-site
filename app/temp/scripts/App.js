...
var StickyHeader = function () {
  ...
  _createClass(StickyHeader, [{
    ...
    value: function createHeaderWaypoint() {
      var that = this;
      new Waypoint({
        element: this.headerTriggerElement[0], //pointer to native dom element
        handler: function handler(direction) {
          //set changing background color
          if (direction == "down") {
...
var Modal = function () {
  ...
  _createClass(Modal, [{
    ...
    value: function events() {
      ...
      (0, _jquery2.default)(document).keyup(this.keyPressHandler.bind(this)); //pushes any key
    }
  }, {
    key: "keyPressHandler",
